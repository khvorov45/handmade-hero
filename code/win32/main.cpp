...
internal win32_game_code Win32LoadGameCode(char* Source, char* Locked) {
    ...
    debug_game_frame_end* DEBUGGameFrameEnd = (debug_game_frame_end*)GetProcAddress(GameCodeDLL, "DEBUGGameFrameEnd");
    ...
    Result.DEBUGGameFrameEnd = DEBUGGameFrameEnd;
...
PLATFORM_READ_DATA_FROM_FILE(Win32ReadDataFromFile) {
    if (PlatformNoFileErrors(Source)) {
        win32_file_handle* Handle = (win32_file_handle*)Source->Platform;
...
int CALLBACK WinMain(HINSTANCE Instance, HINSTANCE PrevInstance, LPSTR CommandLine, int ShowCode) {
    ...
    GameMemory.PlatformAPI.OpenNextFile = Win32OpenFile;
