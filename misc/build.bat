...
set CommonCompilerFlags=-O2 -MTd -nologo -GR- -Gm- -EHa- -Oi -fp:fast -fp:except- -WX -W4 -wd4201 -wd4100 -wd4189 -wd4505 -DHANDMADE_INTERNAL=1 -DHANDMADE_SLOW=1 -DHANDMADE_WIN32=1 -FC -Zo -Z7
